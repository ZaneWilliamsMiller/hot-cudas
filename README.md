...
> 自动整理 2026-05-18 | 78 个热门项目 | 深度源码分析 · Git Submodules · 持续更新
...
| 71 | **Thrust** | 5k | `thrust/thrust` | [Thrust](https://github.com/NVIDIA/thrust) |
| 72 | **cuML** | 5k | `cuml/cuml` | [cuML](https://github.com/rapidsai/cuml) |
| 73 | **Chitu** | 3k | `chitu/chitu` | [Chitu](https://github.com/thu-pacman/chitu) |
| 74 | **CCCL** | 2k | `cccl/cccl` | [CCCL](https://github.com/NVIDIA/cccl) |
| 75 | **PyCUDA** | 2k | `pycuda/pycuda` | [PyCUDA](https://github.com/inducer/pycuda) |
| 76 | **RAFT** | 1k | `raft/raft` | [RAFT](https://github.com/rapidsai/raft) |
| 77 | **RTP-LLM** | 1k | `rtp-llm/rtp-llm` | [RTP-LLM](https://github.com/alibaba/rtp-llm) |
| 78 | **UCC** | 307 | `ucc/ucc` | [UCC](https://github.com/openucx/ucc) |
